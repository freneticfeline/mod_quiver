...
public class RenderTorchArrow extends Render {
    ...
    private static final ResourceLocation arrowTextures = new ResourceLocation(ModFFQuiver.MODID + ":textures/entity/arrow.torch.png");

    public RenderTorchArrow(RenderManager renderManager)
    {
        super(renderManager);
        FMLRelaunchLog.info("RenderTorchArrow constructor");
    }

    public void doRender(EntityTorchArrow p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_, float p_180551_8_, float p_180551_9_)
    {
        FMLRelaunchLog.info("RenderTorchArrow doRender()");
    ...
    protected ResourceLocation getEntityTexture(EntityTorchArrow p_180550_1_)
    {
        FMLRelaunchLog.info("RenderTorchArrow getEntityTexture()");
    ...
    {
        return this.getEntityTexture((EntityTorchArrow)entity);
    }
    ...
    {
        this.doRender((EntityTorchArrow)entity, x, y, z, p_76986_8_, partialTicks);
    }
